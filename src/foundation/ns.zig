...
pub const Copying = opaque {
    pub usingnamespace Methods(Copying);
    ...
    pub fn Methods(comptime T: type) type {
        return struct {
            ...
            pub fn initWithBytesNoCopy_length_encoding_freeWhenDone(self_: *T, bytes_: *const anyopaque, len_: UInteger, encoding_: StringEncoding, freeBuffer_: bool) *T {
                return @as(*const fn (*T, *c.objc_selector, *const anyopaque, UInteger, StringEncoding, bool) callconv(.C) *T, @ptrCast(&c.objc_msgSend))(self_, sel_initWithBytesNoCopy_length_encoding_freeWhenDone_, bytes_, len_, encoding_, freeBuffer_);
            }
